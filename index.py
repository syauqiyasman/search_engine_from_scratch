...
class InvertedIndex:
    ...
    postings_dict: Dictionary mapping:
        ...
        yang memetakan term ID (integer) ke 5-tuple:
           ...
           5. max_tf_in_postings_list : nilai TF maksimum di antara semua dokumen
              pada postings list ini. Digunakan untuk menghitung upper bound skor
              BM25 per term pada algoritma WAND Top-K Retrieval.
...
class InvertedIndexReader(InvertedIndex):
    ...
    def __next__(self):
        ...
        # Gunakan [:4] agar kompatibel dengan 5-tuple (elemen ke-4 = max_tf
        # yang ditambahkan untuk keperluan WAND upper bound).
        pos, number_of_postings, len_in_bytes_of_postings, len_in_bytes_of_tf = \
            self.postings_dict[curr_term][:4]
...
class InvertedIndexWriter(InvertedIndex):
    ...
    def append(self, term, postings_list, tf_list):
        ...
        3. Menyimpan metadata dalam bentuk self.terms, self.postings_dict, dan self.doc_length.
           self.postings_dict memetakan sebuah termID ke sebuah 5-tuple:
                           - start_position_in_index_file
                           - number_of_postings_in_list
                           - length_in_bytes_of_postings_list
                           - length_in_bytes_of_tf_list
                           - max_tf_in_postings_list  ← baru, untuk WAND upper bound
        ...
        # max_tf disimpan sebagai elemen ke-5 pada 5-tuple postings_dict.
        # Digunakan oleh WAND untuk menghitung BM25 upper bound per term
        # tanpa harus membaca seluruh postings list dari disk.
